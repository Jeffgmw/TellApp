package com.teller.tellapp.ui.theme
...
val gray = Color(0xFFC5C4C4)
val darkergray = Color(0xFF6A6A6A)

//val gray3 = Color(0xFF708090)
val white = Color(0xFFFFFFFF)
val accentBrightPurple = Color(0xFFD8BFD8)
